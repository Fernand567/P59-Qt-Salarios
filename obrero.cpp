...
QString Obrero::toString()
{
    ...
    str.append("Salario Bruto: $" + QString::number(m_salarioBruto,'t',2) + "\n");
    str.append("Descuento: $" + QString::number(m_descuento,'t',2) + "\n");
    str.append("Salario Neto: $" + QString::number(m_salarioNeto,'t',2) + "\n");
    return str;
}
